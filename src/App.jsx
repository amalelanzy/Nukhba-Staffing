...
const translations = {
  ar: {
    ...
    hero: [
      {
        ...
        subtitle: "ننتقي لكِ نخبة الكوادر لضمان جودة الحياة وراحة عائلتكِ الدائمة، لتستمتعي بلحظاتكِ الثمينة بينما تتولى نُخبة كوادرنا مهام منزلكِ باحترافية ملكية.",
        tag: "نُخبة الاختيار"
      },
      {
    ...
    pricing: { title: "باقات الايجار الشهري", subtitle: "باقات لاستقدام عمالة منزليه صُممت لتمنحكِ الراحة والرفاهية المطلقة.", currency: "ريال", popular: "الأكثر طلباً", book: "حجز الطلب الآن" },
    modal: {
